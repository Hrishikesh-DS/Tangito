 ...
 * Use the [sendButton.newInstance] factory method to
...
class sendButton : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       button.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_sendButton2_to_mapsFragment2,bundle)
        }
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment sendButton.
         */
